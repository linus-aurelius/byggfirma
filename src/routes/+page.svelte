...
<svelte:head>
  <title>Byggfirma Stockholm - Professionella Byggtjänster</title>
  <meta name="description" content="Vi levererar högkvalitativa byggtjänster med fokus på hållbarhet och kundnöjdhet i Stockholmsområdet." />
